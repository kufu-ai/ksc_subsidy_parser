...
## 対象となる新築住宅建築関連補助金について
- 新築住宅の取得・建築や、それに付随する設備・用地・材料費などに対する補助金、または新築住宅取得・建築を条件とした移住、三世代同居・近居、結婚、若者、子育て世帯などを対象とした補助金を含みます。
- 補助金の説明や対象、タイトルに「新築」という記載がなくても、補助対象に新築住宅が含まれていれば対象としてください。
